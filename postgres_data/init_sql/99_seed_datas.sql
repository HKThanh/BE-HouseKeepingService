...
('as000001-0000-0000-0000-000000000002', 'bd000001-0000-0000-0000-000000000002', 'e1000001-0000-0000-0000-000000000002', 'ASSIGNED', NULL, NULL);

-- Thêm dữ liệu mẫu cho phòng chat và tin nhắn
INSERT INTO chat_rooms (chat_room_id, booking_id, created_at, updated_at) VALUES
('chat0001-0000-0000-0000-000000000001', 'b0000001-0000-0000-0000-000000000001', NOW(), NOW()),
('chat0001-0000-0000-0000-000000000002', 'b0000001-0000-0000-0000-000000000002', NOW(), NOW());

INSERT INTO chat_participants (chat_participant_id, chat_room_id, account_id, participant_role, joined_at) VALUES
('chatp001-0000-0000-0000-000000000001', 'chat0001-0000-0000-0000-000000000001', 'a1000001-0000-0000-0000-000000000001', 'CUSTOMER', NOW()),
('chatp001-0000-0000-0000-000000000002', 'chat0001-0000-0000-0000-000000000001', 'a1000001-0000-0000-0000-000000000005', 'EMPLOYEE', NOW()),
('chatp001-0000-0000-0000-000000000003', 'chat0001-0000-0000-0000-000000000002', 'a1000001-0000-0000-0000-000000000002', 'CUSTOMER', NOW()),
('chatp001-0000-0000-0000-000000000004', 'chat0001-0000-0000-0000-000000000002', 'a1000001-0000-0000-0000-000000000005', 'EMPLOYEE', NOW());

INSERT INTO chat_messages (chat_message_id, chat_room_id, sender_id, message_type, content, attachment_url, reply_to_id, is_revoke, created_at, updated_at) VALUES
('chatmsg01-0000-0000-0000-000000000001', 'chat0001-0000-0000-0000-000000000001', 'a1000001-0000-0000-0000-000000000001', 'TEXT', 'Chào anh Bob, hẹn gặp lại vào 9h nhé!', NULL, NULL, FALSE, NOW() - INTERVAL '2 DAY', NOW() - INTERVAL '2 DAY'),
('chatmsg01-0000-0000-0000-000000000002', 'chat0001-0000-0000-0000-000000000001', 'a1000001-0000-0000-0000-000000000005', 'TEXT', 'Vâng khách yên tâm, em sẽ đến đúng giờ.', NULL, 'chatmsg01-0000-0000-0000-000000000001', FALSE, NOW() - INTERVAL '2 DAY' + INTERVAL '10 MINUTE', NOW() - INTERVAL '2 DAY' + INTERVAL '10 MINUTE'),
('chatmsg01-0000-0000-0000-000000000003', 'chat0001-0000-0000-0000-000000000002', 'a1000001-0000-0000-0000-000000000002', 'IMAGE', 'Ảnh khu vực cần làm sạch', 'https://res.cloudinary.com/demo/image/upload/sample.jpg', NULL, FALSE, NOW() - INTERVAL '1 DAY', NOW() - INTERVAL '1 DAY'),
('chatmsg01-0000-0000-0000-000000000004', 'chat0001-0000-0000-0000-000000000002', 'a1000001-0000-0000-0000-000000000005', 'TEXT', 'Đã xem ảnh, em sẽ chuẩn bị dụng cụ phù hợp.', NULL, 'chatmsg01-0000-0000-0000-000000000003', FALSE, NOW() - INTERVAL '1 DAY' + INTERVAL '5 MINUTE', NOW() - INTERVAL '1 DAY' + INTERVAL '5 MINUTE'),
('chatmsg01-0000-0000-0000-000000000005', 'chat0001-0000-0000-0000-000000000002', 'a1000001-0000-0000-0000-000000000002', 'TEXT', 'Tin nhắn này đã được thu hồi', NULL, NULL, TRUE, NOW() - INTERVAL '12 HOUR', NOW() - INTERVAL '6 HOUR');
