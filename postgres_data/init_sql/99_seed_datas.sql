...
('chatms01-0000-0000-0000-000000000001', 'chat0001-0000-0000-0000-000000000001', 'a1000001-0000-0000-0000-000000000001', 'TEXT', 'Chào anh Bob, hẹn gặp lại vào 9h nhé!', NULL, NULL, FALSE, NOW() - INTERVAL '2 DAY', NOW() - INTERVAL '2 DAY'),
('chatms01-0000-0000-0000-000000000002', 'chat0001-0000-0000-0000-000000000001', 'a1000001-0000-0000-0000-000000000005', 'TEXT', 'Vâng khách yên tâm, em sẽ đến đúng giờ.', NULL, 'chatms01-0000-0000-0000-000000000001', FALSE, NOW() - INTERVAL '2 DAY' + INTERVAL '10 MINUTE', NOW() - INTERVAL '2 DAY' + INTERVAL '10 MINUTE'),
('chatms01-0000-0000-0000-000000000003', 'chat0001-0000-0000-0000-000000000002', 'a1000001-0000-0000-0000-000000000002', 'IMAGE', 'Ảnh khu vực cần làm sạch', 'https://res.cloudinary.com/demo/image/upload/sample.jpg', NULL, FALSE, NOW() - INTERVAL '1 DAY', NOW() - INTERVAL '1 DAY'),
('chatms01-0000-0000-0000-000000000004', 'chat0001-0000-0000-0000-000000000002', 'a1000001-0000-0000-0000-000000000005', 'TEXT', 'Đã xem ảnh, em sẽ chuẩn bị dụng cụ phù hợp.', NULL, 'chatms01-0000-0000-0000-000000000003', FALSE, NOW() - INTERVAL '1 DAY' + INTERVAL '5 MINUTE', NOW() - INTERVAL '1 DAY' + INTERVAL '5 MINUTE'),
('chatms01-0000-0000-0000-000000000005', 'chat0001-0000-0000-0000-000000000002', 'a1000001-0000-0000-0000-000000000002', 'TEXT', 'Tin nhắn này đã được thu hồi', NULL, NULL, TRUE, NOW() - INTERVAL '12 HOUR', NOW() - INTERVAL '6 HOUR');
