...
public class PricingRule {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "pricing_rules_id_gen")
    @SequenceGenerator(name = "pricing_rules_id_gen", sequenceName = "pricing_rules_rule_id_seq", allocationSize = 1)
